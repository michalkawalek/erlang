...
priv_dir(App) ->
  case code:priv_dir(App) of
    {error, bad_name} ->
	 error_logger:info_msg("error !!! nie wiem ~n "), "./priv";
    PrivDir -> filename:absname(PrivDir)
  end.

priv_dir2() ->
case code:add_path("/home/galaisius/erlang/fetjaba-post-1/priv") of
	false -> error_logger:info_msg("error !!!!!!!!!!!!"), "./priv";
	_ -> ok
end.
...
otp_lib2() -> "/usr/lib/erlang/lib/OtpErlang.jar".
